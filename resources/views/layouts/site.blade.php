...
<body>
  ...
  <header class="site-header" id="site-header">
    <nav class="wrap nav-row" aria-label="Main navigation">
      ...
      <div class="nav-links" id="nav-links">
        <a href="{{ route('home') }}#vision">Vision</a><a href="{{ route('home') }}#how-it-works">How it works</a><a href="{{ route('home') }}#platform">Platform</a><a href="{{ route('docs.index') }}">Documentation</a>
  ...
  <footer class="site-footer"><div class="wrap"><div class="footer-row"><a class="brand" href="{{ route('home') }}" aria-label="Illuna home"><svg class="brand-mark" aria-hidden="true"><use href="#i-mark"/></svg>illuna</a><p class="small">Software, more personal.</p><div class="footer-links"><a href="{{ route('home') }}#vision">Vision</a><a href="{{ route('home') }}#roadmap">Roadmap</a><a href="{{ route('docs.index') }}">Documentation</a></div></div><p class="footer-note">Illuna is in the prototyping phase. Explore the product vision, try the interactive examples and learn how controlled adaptation works.</p></div></footer>
